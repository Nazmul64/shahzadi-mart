...
class PurchaseController extends Controller
{
    ...
    public function show(Purchase $purchase)
    {
        ...
        return view('admin.purchases.show', compact('purchase', 'products'));
    }
    ...
    {
        $purchase->load(['supplier', 'items.product']);
        return view('admin.purchases.pdf', compact('purchase'));
    }
    ...
    public function summary(Request $request)
    {
        ...
        return view('admin.purchases.summary', compact('items', 'products', 'purchases', 'suppliers'));
    }
}
