...
class PurchaseController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('emplee.purchases.index', compact('purchases', 'suppliers'));
    }
    ...
    {
        $suppliers = Supplier::where('status', true)->get();
        return view('emplee.purchases.create', compact('suppliers'));
    }
    ...
    public function show(Purchase $purchase)
    {
        ...
        return view('emplee.purchases.show', compact('purchase', 'products'));
    }
    ...
    public function destroy(Purchase $purchase)
    {
        ...
        $purchase->delete();
        return redirect()->route('emplee.purchases.index')
    ...
    {
        $purchase->load(['supplier', 'items.product']);
        return view('emplee.purchases.pdf', compact('purchase'));
    }
    ...
    public function summary(Request $request)
    {
        ...
        return view('emplee.purchases.summary', compact('items', 'products', 'purchases', 'suppliers'));
    }
}
