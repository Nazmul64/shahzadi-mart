...
class PurchaseReturnController extends Controller
{
    public function index()
    {
        ...
        return view('emplee.purchase_returns.index', compact('returns'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('emplee.purchase_returns.create', compact('purchase'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('emplee.purchase-returns.index')
