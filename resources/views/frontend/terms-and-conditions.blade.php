        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-8">
                <div style="display: inline-flex; align-items: center; background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); border-radius: 50px; padding: 8px 20px; margin-bottom: 20px;">
                    <i class="fas fa-file-contract" style="color: #e2b96f; margin-right: 8px;"></i>
                ...
                <h1 style="color: #ffffff; font-size: 48px; font-weight: 700; margin-bottom: 15px; line-height: 1.2;">
                    Terms & <span style="color: #e2b96f;">Conditions</span>
                </h1>
            ...
            <div class="col-lg-9">
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px; margin-bottom: 35px;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <div>
                            ...
                            <h5 style="margin: 0; color: #1a1a2e; font-weight: 700;">{{ $termsAndConditions->title ?? 'Terms & Conditions' }}</h5>
                        </div>
                    </div>
                    <div style="background: #fff3cd; border: 1px solid #ffc107; border-radius: 8px; padding: 8px 16px; display: flex; align-items: center; gap: 8px;">
                        ...
                        <span style="color: #856404; font-size: 13px; font-weight: 500;">
                            Last Updated: {{ optional($termsAndConditions->updated_at)->format('d F, Y') ?? date('d F, Y') }}
                        </span>
                    </div>
                </div>
                ...
                <div style="background: linear-gradient(135deg, #e8f4fd, #dbeafe); border-left: 4px solid #3b82f6; border-radius: 0 12px 12px 0; padding: 20px 25px; margin-bottom: 35px;">
                    <div style="display: flex; align-items: flex-start; gap: 15px;">
                        ...
                        <div>
                            <h6 style="color: #1e40af; font-weight: 700; margin-bottom: 6px; font-size: 15px;">Important Notice</h6>
                            <p style="color: #1e3a8a; margin: 0; font-size: 14px; line-height: 1.7;">
                                By accessing and using
                                <strong>{{ $websetting->site_name ?? config('app.name') }}</strong>,
                ...
                <div style="background: #ffffff; border-radius: 16px; box-shadow: 0 4px 30px rgba(0,0,0,0.08); overflow: hidden;">
                    ...
                    <div style="background: linear-gradient(135deg, #1a1a2e, #16213e); padding: 25px 35px; display: flex; align-items: center; gap: 15px;">
                        <div style="background: rgba(226,185,111,0.2); width: 50px; height: 50px; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                            <i class="fas fa-scroll" style="color: #e2b96f; font-size: 20px;"></i>
                        </div>
                        <div>
                            <h4 style="color: #ffffff; margin: 0; font-weight: 700; font-size: 20px;">Full Terms & Conditions</h4>
                    ...
                    <div style="padding: 40px 35px;">
                        <div class="terms-content" style="color: #4a5568; font-size: 15px; line-height: 1.9;">
                            {!! $termsAndConditions->content ?? '<p>No content available.</p>' !!}
                        </div>
                    </div>
                    ...
                    <div style="background: #f8f9fa; border-top: 1px solid #e9ecef; padding: 20px 35px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px;">
                        <div style="display: flex; align-items: center; gap: 8px; color: #6c757d; font-size: 13px;">
                            ...
                            <span>This document is legally binding upon acceptance.</span>
                        </div>
                ...
                {{-- Agreement Section --}}
                <div style="margin-top: 35px; background: linear-gradient(135deg, #f0fdf4, #dcfce7); border: 1px solid #86efac; border-radius: 16px; padding: 30px 35px; display: flex; align-items: center; gap: 20px; flex-wrap: wrap;">
                    <div style="background: #22c55e; width: 55px; height: 55px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        <i class="fas fa-check" style="color: white; font-size: 22px;"></i>
                    </div>
                    <div style="flex: 1; min-width: 200px;">
                        <h5 style="color: #14532d; font-weight: 700; margin-bottom: 5px;">You Agree By Using Our Services</h5>
                        <p style="color: #166534; margin: 0; font-size: 14px; line-height: 1.6;">
                            Continued use of
                            <strong>{{ $websetting->site_name ?? config('app.name') }}</strong>
                            constitutes your acceptance of these terms and conditions and any future updates.
                        </p>
                    </div>
                    <a href="{{ url('/') }}"
                       style="background: #16a34a; color: white; padding: 12px 25px; border-radius: 10px; text-decoration: none; font-size: 14px; font-weight: 600; white-space: nowrap; display: flex; align-items: center; gap: 8px;">
                ...
                <div style="background: #ffffff; border-radius: 16px; box-shadow: 0 4px 30px rgba(0,0,0,0.08); padding: 80px 40px; text-align: center;">
                    ...
                    <h4 style="color: #495057; font-weight: 700; margin-bottom: 12px;">No Terms Available</h4>
                    <p style="color: #adb5bd; font-size: 15px; margin-bottom: 25px;">Terms & Conditions content has not been added yet.</p>
                    <a href="{{ url('/') }}"
