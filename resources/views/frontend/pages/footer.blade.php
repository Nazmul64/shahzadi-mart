...
{{-- ── MOBILE BOTTOM NAV (duplicate removed — already in header) ── --}}
        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-col__list">
                    ...
                    <li><a href="#"><i class="bi bi-chevron-right"></i> Track Your Order</a></li>
...
.fc-notif {
    ...
    z-index: 3; animation: fc-pulse 2s ease infinite;
}
...
.lc-dot {
    ...
    display: inline-block; animation: fc-pulse 1.8s ease infinite;
}
.lc-close {
...
.lc-body {
    ...
    display: flex; flex-direction: column; gap: 10px; background: #f0f4f8;
}
.lc-bubble {
...
.lc-bubble--in {
    ...
    align-self: flex-start; box-shadow: 0 1px 4px rgba(0,0,0,.07);
}
.lc-bubble--out {
