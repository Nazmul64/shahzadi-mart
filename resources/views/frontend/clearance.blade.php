{{-- resources/views/frontend/clearance.blade.php --}}
...
.smp-hero-text h1 { font-size: 32px; font-weight: 900; margin-bottom: 8px; color: #ffcc00; }
...
.smp-card:hover { transform: translateY(-6px); box-shadow: 0 20px 40px rgba(0,0,0,.08); border-color: #ffcc0044; }
...
<div class="smp-allprod content-area-inner">
    <div class="smp-hero">
        <div class="smp-hero-text">
            <h1>ক্লিয়ারেন্স সেল</h1>
            <p>স্টক শেষ হওয়ার আগেই সেরা অফারে কিনে নিন</p>
        </div>
        ...
        @foreach($products as $item)
            ...
            <div class="smp-card-wrap">
                <div class="smp-card">
                    ...
                    @if($discount)
                        <span class="smp-badge">-{{ $discount }}% OFF</span>
                    @endif
