{{-- resources/views/frontend/flash-sales.blade.php --}}
...
/* ══ HERO ══ */
.smp-hero {
    background: linear-gradient(135deg, #be0318 0%, #1a1a1a 100%);
...
.smp-card:hover { transform: translateY(-6px); box-shadow: 0 20px 40px rgba(0,0,0,.08); border-color: #be031844; }
...
.smp-card-price { font-size: 22px; font-weight: 900; color: #be0318; margin-bottom: 4px; }
...
.smp-atc-btn--active { background: #be0318; color: #fff; }
...
<div class="smp-allprod content-area-inner">
    <div class="smp-hero">
        <div class="smp-hero-text">
            <h1>ফ্ল্যাশ সেল</h1>
            <p>সেরা ডিলগুলো লুফে নিন সীমিত সময়ের জন্য</p>
        </div>
        <div class="smp-hero-count">
            <span class="smp-hero-count-num">{{ $flashProducts->total() }}</span>
            <span class="smp-hero-count-label">টি ডিল</span>
        </div>
    </div>
