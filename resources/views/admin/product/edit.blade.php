    ...
    <div class="row g-3">
        ...
        <div class="col-lg-4">
            ...
            <div class="sidebar-card">
                ...
                <div class="feature-img-box"
                    ...
                    @if($product->feature_image && file_exists(public_path('uploads/products/' . $product->feature_image)))
                        <img id="featureImgPreview"
                             ...
                             style="display:block;" alt="Feature Image">
                    @else
                ...
                <input type="file" name="feature_image" id="feature_image_input"
                        ...
                        @foreach($product->gallery_images as $img)
                            ...
                            <div class="gallery-card" id="gex_{{ $imgName }}">
                                ...
                                <button type="button" class="btn-rm"
                                        onclick="removeExistingGallery('{{ $imgName }}')">
                                    &#10005; Remove
                                </button>
                            </div>
                        @endforeach
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-1">
                        ...
                        <div class="form-check form-switch mb-0">
                            ...
                            <label class="form-check-label" for="is_unlimited"
                                   style="font-size:.8rem;">Unlimited</label>
                        </div>
                    </div>
            ...
            <div class="flash-sale-card">
                ...
                <div class="toggle-switch-wrap mb-3">
                    <div class="form-check form-switch mb-0">
                        <input class="form-check-input" type="checkbox"
                               name="is_flash_sale" id="is_flash_sale" value="1"
                ...
                <div class="flash-sale-fields" id="flashSaleFields"
                    ...
                    <div class="mb-3">
                        <label class="form-label-custom">
                            Sale Starts At <span class="optional-badge">Optional</span>
                        </label>
                        <input type="datetime-local" name="flash_sale_starts_at" class="form-control"
                               value="{{ old('flash_sale_starts_at', $product->flash_sale_starts_at
                                   ? $product->flash_sale_starts_at->format('Y-m-d\TH:i') : '') }}">
                    </div>
                    <div class="mb-0">
                        <label class="form-label-custom">
                            Sale Ends At <span class="optional-badge">Optional</span>
                        </label>
            ...
            <div class="bestseller-card">
                ...
                <div class="toggle-switch-wrap">
                    <div class="form-check form-switch mb-0">
                        <input class="form-check-input" type="checkbox"
                               name="is_bestseller" id="is_bestseller" value="1"
