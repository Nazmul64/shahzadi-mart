    ...
    <div class="col-lg-4">
        ...
        <div class="sidebar-card">
            ...
            <div class="feature-img-box" onclick="document.getElementById('feature_image_input').click()">
                <img id="featureImgPreview" src="" alt="">
        ...
        <div class="sidebar-card">
            <div class="mb-3">
                ...
                <input type="number" step="0.01" name="current_price" class="form-control" placeholder="e.g 20" value="{{ old('current_price') }}">
            </div>
            <div class="mb-3">
                <label class="form-label-custom">Product Discount Price <span class="form-label-sub">(Optional)</span></label>
                <input type="number" step="0.01" name="discount_price" class="form-control" placeholder="e.g 15" value="{{ old('discount_price') }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="youtube_url" class="form-control" placeholder="Enter Youtube Video URL" value="{{ old('youtube_url') }}">
            </div>
        </div>
...
<script>
var URL_SUB   = "{{ route('products.getSubCategories') }}";
var URL_CHILD = "{{ route('products.getChildCategories') }}";
var galleryItems = [];
...
$(document).ready(function () {
    ...
    $('#product_category').on('change', function () {
        ...
        $.get(URL_SUB, { category_id: catId }, function(data) {
            ...
            $('#sub_hint').html(data.length ? '<span style="color:green;">&#10003; '+data.length+' sub category found</span>' : '<span style="color:#e67e22;">No sub categories found</span>');
    ...
    $('#product_subcategory').on('change', function () {
        ...
        if (!subId) { $('#child_hint').text('Select a sub category above to load child categories'); return; }
        $('#child_hint').html('<span style="color:#e67e22;">Loading...</span>');
        $.get(URL_CHILD, { sub_category_id: subId }, function(data) {
            ...
            $('#child_hint').html(data.length ? '<span style="color:green;">&#10003; '+data.length+' child category found</span>' : '<span style="color:#e67e22;">No child categories found</span>');
...
function rebuildGalleryInputs() {
    ...
    galleryItems.forEach(function(item) {
        ...
        var dt = new DataTransfer(); dt.items.add(item.file); inputEl[0].files = dt.files;
