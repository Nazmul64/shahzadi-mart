...
.img-upload-box img { width: 100%; height: 150px; object-fit: cover; border-radius: 8px; }
...
.banner-box img { height: 180px; }

/* ── Image Preview with Remove ── */
.img-preview-wrap { position: relative; display: inline-block; width: 100%; }
.img-remove-btn {
...
<div class="acf-wrapper">
    ...
    <div class="acf-topbar">
        <div>
            <h2><i class="bi bi-building-add me-2" style="color:#1a2b6b;"></i>Add Company Information</h2>
            <div class="acf-breadcrumb">Dashboard › Company Information › Add</div>
        </div>
    ...
    <form action="{{ route('admin.aboutcompany.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-lg-8">
                ...
                <div class="acf-card">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="company_name" class="form-control"
                               placeholder="e.g. Shahzadi Mart Ltd." value="{{ old('company_name') }}">
                    </div>

                    <div class="mb-3">
                        <label class="acf-label">Tagline <span class="optional">Optional</span></label>
                        <input type="text" name="tagline" class="form-control"
                               placeholder="e.g. Your Trusted Online Shop" value="{{ old('tagline') }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="short_description" class="form-control" rows="3"
                                  placeholder="Hero section এ দেখানোর জন্য সংক্ষিপ্ত বিবরণ...">{{ old('short_description') }}</textarea>
                        <span class="acf-hint">Website এর hero/banner section এ দেখাবে।</span>
                    </div>
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="about_description" class="form-control" rows="6"
                                  placeholder="Company সম্পর্কে বিস্তারিত বিবরণ...">{{ old('about_description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="acf-card">
                    ...
                    <div class="two-col mb-3">
                        <div>
                            ...
                            <input type="email" name="email" class="form-control"
                                   placeholder="info@company.com" value="{{ old('email') }}">
                        </div>
                        <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="website" class="form-control"
                               placeholder="https://yoursite.com" value="{{ old('website') }}">
                    </div>
                    <div class="mb-0">
                ...
                <div class="acf-card">
                    ...
                    <div class="social-row">
                        ...
                        <input type="url" name="twitter" class="form-control" placeholder="https://twitter.com/yourpage" value="{{ old('twitter') }}">
                    </div>
                    <div class="social-row">
                        <div class="social-icon" style="background:#ff0000;color:#fff;"><i class="bi bi-youtube"></i></div>
                        <input type="url" name="youtube" class="form-control" placeholder="https://youtube.com/yourchannel" value="{{ old('youtube') }}">
                    </div>
                    <div class="social-row" style="margin-bottom:0;">
                        ...
                        <input type="url" name="linkedin" class="form-control" placeholder="https://linkedin.com/company/yourpage" value="{{ old('linkedin') }}">
                    </div>
                </div>
                ...
                <div class="acf-card" style="border:1px solid #fde68a;background:#fffbeb;">
                    ...
                    <div class="mb-0">
                        ...
                        <textarea name="meta_description" class="form-control" rows="3"
                                  placeholder="Search engine description (max 160 chars)...">{{ old('meta_description') }}</textarea>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="acf-card">
                    ...
                    <div class="img-upload-box" onclick="document.getElementById('logo_input').click()">
                        <img id="logo_preview" src="" style="display:none;">
                ...
                <div class="acf-card">
                    ...
                    <div class="img-upload-box banner-box" onclick="document.getElementById('banner_input').click()">
                        <img id="banner_preview" src="" style="display:none;">
                        <div class="img-placeholder" id="banner_placeholder">
                            <i class="bi bi-cloud-upload"></i>
                            <span>Click to upload banner</span>
                            <small style="display:block;margin-top:4px;color:#cbd5e0;">JPG, PNG, WEBP · Max 4MB · Recommended: 1200×400</small>
                        </div>
                    </div>
                ...
                <div class="acf-card">
                    ...
                    <div class="img-upload-box" onclick="document.getElementById('about_img_input').click()">
                        <img id="about_img_preview" src="" style="display:none;">
                ...
                <button type="submit" class="btn-acf btn-save w-100" style="border-radius:8px;padding:12px;">
                    <i class="bi bi-check-lg"></i> Company Information Save করুন
                </button>
