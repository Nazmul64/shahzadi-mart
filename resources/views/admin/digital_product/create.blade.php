    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.digital-products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="sku" id="sku" class="form-control" placeholder="Ex: 134543">
                        </div>
                        <div class="col-md-4 mb-3">
                ...
                <div class="card-body pt-0">
                    <div class="mb-4">
                        ...
                        <div class="upload-box border-dashed rounded p-4 text-center" style="border: 2px dashed #dee2e6; cursor: pointer;" onclick="document.getElementById('product_file').click()">
                            ...
                            <p class="mb-0 mt-2 text-muted">Click to upload file (Zip, PDF, etc.)</p>
                        </div>
                    </div>
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" step="0.01" name="buying_price" class="form-control" placeholder="Buying Price">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Selling Price</label>
                            <input type="number" step="0.01" name="current_price" class="form-control" value="10">
                        </div>
                        <div class="col-md-4 mb-3">
                ...
                <div id="videoCollapse" class="collapse">
                    <div class="card-body pt-0">
                        <div class="row">
                            ...
                            <div class="col-md-9 mb-3" id="video_file_input">
                            ...
                            <div class="col-md-9 mb-3 d-none" id="video_url_input">
                                <label class="form-label">YouTube Video Link</label>
                                <input type="text" name="video_url" class="form-control" placeholder="Ex: https://www.youtube.com/embed/XXXX">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-end gap-2 mb-5">
                ...
                <button type="submit" class="btn btn-danger px-5" style="background: #ff0055; border-color: #ff0055;">Submit</button>
            </div>
