...
<style>
    ...
    .r-perm-all-btn{font-size:10px;font-weight:600;color:rgba(255,255,255,.8);border:1px solid rgba(255,255,255,.3);border-radius:4px;padding:1px 7px;cursor:pointer;background:transparent;}
    ...
    .r-stat-row{display:flex;justify-content:space-between;align-items:center;padding:7px 0;border-bottom:1px solid #f1f5f9;font-size:13px;}
    .r-stat-row:last-child{border-bottom:none;padding-bottom:0;}
    .r-stat-row:first-child{padding-top:0;}
    ...
    <form action="{{ route('admin.roles.update', $role->id) }}" method="POST">
        ...
        <div class="r-layout">
                ...
                <div class="r-card">
                    ...
                    <div class="r-card-body">
                        <div class="r-field-group">
                            ...
                            @error('name')<div class="r-err-msg">{{ $message }}</div>@enderror
                            <div style="font-size:12px;color:#64748b;margin-top:5px;">
                                Slug: <code style="background:#f1f5f9;padding:1px 6px;border-radius:4px;color:#2d6a9f;">{{ $role->slug }}</code>
                            </div>
                        </div>
                        <div class="r-field-group">
                            <label class="r-label">বিবরণ</label>
                            <textarea name="description" class="r-textarea">{{ old('description', $role->description) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="r-card">
                    <div class="r-card-head">
                        ...
                        <span class="r-perm-count ms-auto">
                            <i class="bi bi-check-circle"></i><span id="permCount">0</span> selected
                        </span>
                    </div>
                    <div class="r-card-body">
            ...
            <div>
                ...
                <div class="r-side-card">
                    <div class="r-side-head"><i class="bi bi-toggles"></i><h6>অপশন</h6></div>
                    <div class="r-side-body">
                        <div class="r-toggle-row">
                            <div>
                                <span class="r-toggle-label">Active Status</span>
                                <span class="r-toggle-sub">সক্রিয় রাখুন</span>
                            </div>
                ...
                <div class="r-side-card">
                    <div class="r-side-head"><i class="bi bi-bar-chart"></i><h6>পরিসংখ্যান</h6></div>
                    <div class="r-side-body">
                        <div class="r-stat-row">
                            <span style="color:#64748b;">মোট পারমিশন</span>
                            <strong style="color:#2d6a9f;">{{ $role->permissions->count() }}</strong>
                        </div>
                        <div class="r-stat-row">
                            <span style="color:#64748b;">মোট ইউজার</span>
                            <strong style="color:#15803d;">{{ $role->users->count() }}</strong>
                        </div>
                    </div>
                </div>
            </div>
