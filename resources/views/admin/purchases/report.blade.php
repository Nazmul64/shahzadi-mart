...
<div class="pm-wrap">
    ...
    <form class="pm-filter" method="GET" action="{{ route('admin.purchases.report') }}">
        <div>
            <label>Product</label>
        ...
        <a href="{{ route('admin.purchases.report') }}" class="pm-btn pm-btn-ghost"><i class="bi bi-x-lg"></i> Clear</a>
    </form>
