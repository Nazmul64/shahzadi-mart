        ...
        <table id="subCategoryTable" class="table table-bordered w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {{-- Status Toggle --}}
                    <td class="text-center">
                        <a href="{{ route('subcategory.toggle-status', $item->id) }}"
            ...
            <form id="editSubCatForm" action="" method="POST">
                ...
                <div class="modal-body py-4">
                    ...
                    <div class="row mb-3 align-items-start">
                        ...
                        <div class="col-8">
                            <input type="text" name="slug" id="edit_sub_slug" class="form-control" readonly>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    $(document).on('click', '.btn-open-edit', function () {
        ...
        $('#editSubCatForm').attr('action', '/subcategory/' + id);
