        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Add Delivery Information</h4>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.DeliveryInformation.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="home_delivery_description" rows="3"
                                              ...
                                              placeholder="Enter description">{{ old('home_delivery_description') }}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="pickup_description" rows="3"
                                              ...
                                              placeholder="Enter description">{{ old('pickup_description') }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="instant_download_title"
                                           ...
                                           value="{{ old('instant_download_title') }}"
                                           placeholder="Enter title">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="instant_download_description" rows="3"
                                              ...
                                              placeholder="Enter description">{{ old('instant_download_description') }}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="secure_description" rows="3"
                                              ...
                                              placeholder="Enter description">{{ old('secure_description') }}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="cod_description" rows="3"
                                              ...
                                              placeholder="Enter description">{{ old('cod_description') }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile_banking_title"
                                           ...
                                           value="{{ old('mobile_banking_title') }}"
                                           placeholder="Enter title">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="mobile_banking_description" rows="3"
                                              ...
                                              placeholder="Enter description">{{ old('mobile_banking_description') }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea name="footer_company_information" rows="4"
                                              ...
                                              placeholder="Enter company information">{{ old('footer_company_information') }}</textarea>
