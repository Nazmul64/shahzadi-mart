...
.io-icon-btn.fraud-check { color: #e84393; border-color: #fdcb6e; }
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="io-actions">
                                        ...
                                        {{-- Fraud Check --}}
                                        <button type="button" class="io-icon-btn fraud-check" title="Check Fraud/Success"
                                                onclick="checkFraud('{{ $order->phone }}')">
                                ...
                                <td>
                                    @php
                                        $fraud = $order->fraudProfile;
                                    @endphp
                                    @if($fraud)
                                        @if($fraud->is_blocked)
                                            <span class="badge bg-dark text-white" style="font-size: 10px; cursor: pointer;" onclick="checkFraud('{{ $order->phone }}')">BLOCKED</span>
                                        @elseif($fraud->status === 'fake')
                                            <span class="badge bg-danger text-white" style="font-size: 10px; cursor: pointer;" onclick="checkFraud('{{ $order->phone }}')">FAKE</span>
                                        @elseif($fraud->status === 'real')
                                            <span class="badge bg-success text-white" style="font-size: 10px; cursor: pointer;" onclick="checkFraud('{{ $order->phone }}')">REAL</span>
                                        @else
                                            <span class="badge bg-info text-white" style="font-size: 10px; cursor: pointer;" onclick="checkFraud('{{ $order->phone }}')">CHECKED</span>
                                        @endif
                                    @else
