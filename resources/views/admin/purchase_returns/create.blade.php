...
<div class="pur-wrap">
    ...
    {{-- Search --}}
    <form method="GET" action="{{ route('admin.purchase-returns.create') }}">
        <div class="search-card">
            ...
            <a href="{{ route('admin.purchase-returns.create') }}" class="btn btn-green">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
    ...
    <form action="{{ route('admin.purchase-returns.store') }}" method="POST">
        ...
        <div class="pur-card">
            ...
            <div class="form-footer">
                <a href="{{ route('admin.purchase-returns.index') }}" class="btn btn-cancel">Cancel</a>
