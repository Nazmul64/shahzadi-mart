...
<div class="ao-wrapper">
    ...
    <div class="ao-actionbar">
        ...
        {{-- Bulk Change Status --}}
        <button class="ao-btn btn-status" type="button" onclick="openBulkStatusModal()">
        ...
        <button class="ao-btn btn-print" type="button" onclick="window.print()">
            <i class="bi bi-printer"></i> Print
        </button>

        {{-- Bulk Pathao Send --}}
        <button class="ao-btn btn-pathao" type="button" onclick="handleBulkPathaoClick()">
...
{{-- ════════════════════════════════════════════════
     PATHAO MODAL
════════════════════════════════════════════════ --}}
<div class="pathao-overlay" id="pathao-overlay">
    <div class="pathao-modal-box">
        ...
        <div style="margin-bottom:22px;">
            <label class="pm-label">Area
                <span style="font-size:11px;color:#aaa;font-weight:400;">(Optional)</span>
            </label>
        ...
        <div style="display:flex;gap:10px;justify-content:flex-end;">
            ...
            <button type="button" id="pathao-submit-btn"
...
/* ═══════════════════════════════════════════════════
   STATE
═══════════════════════════════════════════════════ */
var pathaoMode    = 'single'; // 'single' বা 'bulk'
var pathaoOrderId = null;     // single mode এ order id
var pathaoBulkUrl = '{{ route("admin.pathao.bulk-send") }}';

/* ═══════════════════════════════════════════════════
   PATHAO MODAL OPEN / CLOSE
═══════════════════════════════════════════════════ */
function openPathaoModal() {
    ...
    // ✅ KEY FIX: class দিয়ে নয়, সরাসরি style.display ব্যবহার করো
...
function handleBulkPathaoClick() {
    ...
    pathaoMode    = 'bulk';
    pathaoOrderId = null;
    document.getElementById('pathao-modal-subtitle').textContent = checkedBoxes.length + ' টি অর্ডার';
    openPathaoModal();
}

/* ═══════════════════════════════════════════════════
   SINGLE ROW PATHAO BUTTON CLICK
═══════════════════════════════════════════════════ */
