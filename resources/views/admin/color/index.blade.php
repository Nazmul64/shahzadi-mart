            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <form action="{{ route('admin.color.toggle', $color->id) }}" method="POST" class="d-inline">
                            @csrf
...
<script>
    ...
    function openEditModal(id, name, colorCode) {
        const url = "{{ route('admin.color.update', ['color' => '__ID__']) }}".replace('__ID__', id);
    ...
    function openDeleteModal(id, name) {
        const url = "{{ route('admin.color.destroy', ['color' => '__ID__']) }}".replace('__ID__', id);
