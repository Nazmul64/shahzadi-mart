        ...
        <table class="unit-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $unit->name }}</td>
                    <td>
                        <form action="{{ route('admin.unit.toggle', $unit->id) }}" method="POST" class="d-inline">
                            @csrf
...
<script>
    ...
    function openEditModal(id, name) {
        const url = "{{ route('admin.unit.update', ['unit' => '__ID__']) }}".replace('__ID__', id);
    ...
    function openDeleteModal(id, name) {
        const url = "{{ route('admin.unit.destroy', ['unit' => '__ID__']) }}".replace('__ID__', id);
