...
<style>
    ...
    .img-upload-overlay {
        ...
        background: rgba(255,255,255,0.85); width: 100%;
        text-align: center; padding: 8px 0; font-size: .85rem; color: #333;
        ...
        <table id="categoryTable" class="table table-bordered w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.category.toggle-featured', $item->id) }}"
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.category.toggle-status', $item->id) }}"
                ...
                <div class="modal-body py-4">
                    ...
                    <div class="row mb-3 align-items-start">
                        <div class="col-3 modal-label">
                            Name * <div class="modal-sublabel">(In Any Language)</div>
                        </div>
                        <div class="col-9">
                            <input type="text" name="category_name" id="create_name"
                    ...
                    <div class="row mb-3 align-items-start">
                        <div class="col-3 modal-label">
                            Slug * <div class="modal-sublabel">(Auto-generated)</div>
                        </div>
                        <div class="col-9">
...
$(document).ready(function () {
    ...
    $('#btnAddNew').on('click', function () {
        ...
        document.getElementById('create_preview').style.display = 'none';
    ...
    $(document).on('click', '.btn-open-edit', function () {
        ...
        var previewEl = document.getElementById('edit_preview');
        if (photo) {
            previewEl.src = photo;
