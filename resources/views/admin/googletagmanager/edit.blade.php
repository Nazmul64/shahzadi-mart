...
<div class="pf-wrap">
    <div class="pf-inner">
        ...
        <div class="pf-header">
            <h1 class="pf-title">Edit <span>Google Tag</span></h1>
        ...
        <div class="form-card">
            ...
            <div class="edit-meta">
                ...
                <span>Editing tag record <strong>#{{ $pixel->id }}</strong></span>
            </div>

            <form action="{{ route('admin.googletagmanager.update', $pixel->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="field-group">
                    ...
                    <input type="text"
                           name="google_tag_id"
                           value="{{ old('google_tag_id', $pixel->google_tag_id) }}"
                ...
                <div class="field-group">
                    ...
                    <div class="toggle-row">
                        ...
                        <span class="toggle-label-text">
                            {{ $pixel->status ? 'Currently Active' : 'Currently Inactive' }}
                        </span>
                    </div>
                </div>
                ...
                <div class="btn-row">
                    <a href="{{ route('admin.googletagmanager.index') }}" class="btn-cancel">Cancel</a>
                    <button type="submit" class="btn-update">Update Google Tag</button>
                </div>
            </form>
        </div>
