...
.cf-section-title::after {
    content: '';
    flex: 1; height: 1px; background: #edf0fb;
}
...
@media (max-width: 700px) {
    ...
    .cf-field-label { text-align: left !important; padding-right: 0 !important; }
}
.cf-field-label {
    text-align: right;
    padding-right: 4px;
...
.cf-field-label label {
    font-size: 0.875rem; font-weight: 700; color: #2c3a5a;
    display: block;
}
.cf-field-label .hint {
    font-size: 0.74rem; color: #a0aec0; font-weight: 500;
    margin-top: 2px;
}
...
/* Conditional row (hidden by default) */
.cf-conditional { display: none; }
.cf-conditional.show { display: grid; }

/* ── Divider ────────────────────────────────────────── */
.cf-divider {
    height: 1px; background: #f0f3fa;
    margin: 28px 0;
}
...
.cf-btn-submit {
    ...
    cursor: pointer;
    box-shadow: 0 4px 16px rgba(13,42,107,.28);
    transition: transform .18s, box-shadow .18s;
    display: inline-flex; align-items: center; gap: 7px;
}
.cf-btn-submit:hover {
    transform: translateY(-2px);
    box-shadow: 0 8px 24px rgba(13,42,107,.36);
}
</style>
...
<div class="cf-root">
    ...
    <div class="cf-header">
        ...
        <a href="{{ route('coupons.index') }}" class="cf-back-btn">
        ...
        <div class="cf-form-body">
            <form action="{{ route('coupons.store') }}" method="POST">
                ...
                <div class="cf-field cf-conditional" id="childSubRow">
                    <div class="cf-field-label">
                        <label>Child Sub Category <span class="required">*</span></label>
                    </div>
                    <div class="cf-field-control">
                ...
                <div class="cf-submit-wrap">
                    <a href="{{ route('coupons.index') }}" class="cf-btn-cancel">Cancel</a>
