...
.ce-breadcrumb {
    ...
    font-size: 0.8rem; color: #8494b3; margin-top: 6px; padding-left: 48px;
}
...
.ce-back-btn {
    ...
    background: #fff; color: #0d2a6b;
    border: 1.5px solid #c7d2fe;
    border-radius: 10px; padding: 9px 18px;
    font-family: 'Plus Jakarta Sans', sans-serif;
    font-size: 0.85rem; font-weight: 700;
    text-decoration: none;
    box-shadow: 0 2px 8px rgba(13,42,107,.08);
    transition: all .18s;
}
...
/* ── Coupon Preview Pill ────────────────────────────── */
.ce-preview {
    background: linear-gradient(135deg, #0d2a6b 0%, #1e40af 100%);
    border-radius: 14px;
    padding: 18px 26px;
    display: flex;
    align-items: center;
    ...
    gap: 16px;
    margin-bottom: 22px;
    box-shadow: 0 6px 24px rgba(13,42,107,.22);
}
.ce-preview-code {
...
@media (max-width: 700px) {
    .ce-field { grid-template-columns: 1fr; }
    .ce-field-label { text-align: left !important; padding-right: 0 !important; }
}
.ce-field-label {
    text-align: right; padding-right: 4px; padding-top: 9px;
}
...
.ce-unit {
    font-size: 0.88rem; font-weight: 700; color: #8494b3;
    background: #f1f4fb; border: 1.5px solid #dde3f0;
...
.ce-btn-submit {
    ...
    border-radius: 10px; padding: 11px 40px;
    font-family: 'Plus Jakarta Sans', sans-serif;
...
.ce-btn-submit:hover {
    ...
    box-shadow: 0 8px 24px rgba(120,53,15,.36);
}
</style>
...
<div class="ce-root">
    ...
    <div class="ce-header">
        ...
        <a href="{{ route('coupons.index') }}" class="ce-back-btn">
    ...
    <div class="ce-preview">
        ...
        <div class="ce-preview-meta">
            <span class="ce-preview-chip amber">{{ $coupon->type_display }}</span>
            <span class="ce-preview-chip">{{ $coupon->amount_display }}</span>
            <span class="ce-preview-chip">Used: {{ $coupon->used }}</span>
        ...
        <div class="ce-form-body">
            <form action="{{ route('coupons.update', $coupon->id) }}" method="POST">
                ...
                <div class="ce-field">
                    ...
                    <div class="ce-field-control">
                        <select name="allow_product_type" id="allowProductType"
                                onchange="handleProductType()" class="ce-select">
                ...
                <div class="ce-field ce-conditional" id="quantityLimitRow">
                    ...
                    <div class="ce-field-control">
                        <input type="number" name="quantity_limit"
                               value="{{ old('quantity_limit', $coupon->quantity_limit) }}"
                ...
                <div class="ce-submit-wrap">
                    <a href="{{ route('coupons.index') }}" class="ce-btn-cancel">Cancel</a>
