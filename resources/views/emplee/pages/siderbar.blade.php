...
<div id="sidebar">
  ...
  <ul class="sidebar-menu">
    <li><a href="#"><i class="fas fa-shopping-cart"></i> Orders <i class="fa-solid fa-chevron-right"></i> arrow"></i></a></li>
    <li><a href="#"><i class="fas fa-th-large"></i> Categories <i class="fa-solid fa-chevron-right"></i> arrow"></i></a></li>
    <li><a href="#"><i class="fas fa-box"></i> Products <i class="fa-solid fa-chevron-right"></i> arrow"></i></a></li>
  ...
  <ul class="sidebar-menu">
    <li><a href="#"><i class="fas fa-users"></i> Users <i class="fa-solid fa-chevron-right"></i> arrow"></i></a></li>
