...
<div class="pur-wrap">
    ...
    <form action="{{ route('emplee.purchases.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="pur-row">
                    ...
                    <div>
                        ...
                        <div class="supplier-row">
                            ...
                            <button type="button" class="pur-btn-plus" onclick="window.open('{{ route('emplee.suppliers.create') }}', '_blank')">+</button>
                        </div>
        ...
        <div class="pur-footer">
            <a href="{{ route('emplee.purchases.index') }}" class="pur-btn pur-btn-cancel">
                Cancel
            </a>
