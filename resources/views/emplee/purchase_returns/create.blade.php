...
<div class="pur-wrap">
    ...
    {{-- Search --}}
    <form method="GET" action="{{ route('emplee.purchase-returns.create') }}">
        <div class="search-card">
            ...
            <a href="{{ route('emplee.purchase-returns.create') }}" class="btn btn-green">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24">
    ...
    {{-- Return Form --}}
    <form action="{{ route('emplee.purchase-returns.store') }}" method="POST">
        @csrf
        ...
        <div class="pur-card">
            ...
            <div class="form-footer">
                <a href="{{ route('emplee.purchase-returns.index') }}" class="btn btn-cancel">Cancel</a>
