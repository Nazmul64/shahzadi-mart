        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">এমপ্লয়ী প্রোফাইল আপডেট</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('emplee.profile.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <form action="{{ route('emplee.profile.password') }}" method="POST">
                        @csrf
                        <div class="form-group mb-3">
