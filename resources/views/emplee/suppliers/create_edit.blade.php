...
<div class="pm-wrap">
    ...
    <div class="pm-card">
        <form action="{{ isset($supplier) ? route('emplee.suppliers.update', $supplier->id) : route('admin.suppliers.store') }}"
              method="POST">
            @csrf
            ...
            <div class="pm-form-actions">
                ...
                <a href="{{ route('emplee.suppliers.index') }}" class="pm-btn pm-btn-ghost">
