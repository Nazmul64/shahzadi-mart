...
<div class="pm-wrap">
    <div class="pm-top">
        ...
        <a href="{{ route('emplee.suppliers.create') }}" class="pm-btn pm-btn-primary">
                ...
                <tr>
                    <td colspan="7">
                        <div class="pm-empty">
                            ...
                            No suppliers found. <a href="{{ route('emplee.suppliers.create') }}" style="color:var(--pur-accent)">Add one now.</a>
                        </div>
                    </td>
                </tr>
                @endforelse
