@include('frontend.pages.header')
    ...
    <div class="customerdashboard-app-container">
        ...
        <aside class="customerdashboard-sidebar" id="sidebar">
           ...
           <div class="customerdashboard-signout-section">
            ...
            <!-- Logout button -->
            <button class="customerdashboard-signout-btn" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
 ...
 <script src="{{ asset('userdashboard/assets/js/usercustomdashboard.js') }}"></script>
</body>
</html>
