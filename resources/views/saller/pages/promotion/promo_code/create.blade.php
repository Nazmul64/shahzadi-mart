...
<div class="main-content">
    ...
    <div class="page-content" style="background: #f4f7fa;">
        <div class="page-header mb-4 px-3 pt-3">
            ...
            <h2 class="page-title font-w700" style="font-size: 24px; color: #333;">Add New Voucher</h2>
        </div>

        <div class="data-card border-0 shadow-sm mx-3 mb-5" style="border-radius: 12px; background: #fff;">
            <div class="card-header bg-transparent border-bottom-0 pt-4 px-4">
                <h5 class="font-w600" style="font-size: 16px; color: #333;"><i class="bi bi-plus-circle-dotted me-2 text-primary"></i>Add New Voucher</h5>
            </div>
            
            <form action="{{ route('saller.promotion.promo_code.store') }}" method="POST" class="p-4">
                @csrf
                <div class="row g-4">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="type" class="form-select" required onchange="toggleDiscountFields(this)">
                                <option value="discount_by_amount">Amount</option>
                                <option value="discount_by_percentage">Percentage</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" id="discount_amount" class="form-control" placeholder="Discount Amount">
                            <input type="number" name="percentage" id="discount_percentage" class="form-control d-none" placeholder="Discount Percentage %">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label font-w600">Limit For Single User</label>
                            <input type="number" name="quantity_limit" class="form-control" placeholder="ex: 5" required>
                        </div>
                    </div>
                    ...
                    {{-- Add quantity field as it is required in controller --}}
                    ...
                    <div class="col-12 text-end mt-4">
                        ...
                        <button type="submit" class="btn btn-danger px-5" style="background-color: #ff3e6c; border: none; border-radius: 8px;">Submit</button>
                    </div>
                </div>
            </form>
        </div>
