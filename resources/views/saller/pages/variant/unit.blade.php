...
<div class="main-content">
    ...
    <div class="page-content" style="background: #f4f7fa;">
        <div class="page-header mb-4 px-3 pt-3">
            <h2 class="page-title font-w700" style="font-size: 24px; color: #333;">Unit List</h2>
        </div>
        ...
        <div class="data-card border-0 shadow-sm mx-3" style="border-radius: 10px; background: #fff;">
            <div class="data-card-header px-4 py-3 border-bottom-0">
                <h6 class="text-muted mb-0">Units</h6>
            </div>
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f8f9fa;">
                            ...
                            <td class="font-w600" style="color: #333;">{{ $unit->name }}</td>
                            <td class="text-end">
                                <div class="form-check form-switch d-inline-block">
                                    <input class="form-check-input custom-switch" type="checkbox" disabled {{ $unit->is_active == 1 ? 'checked' : '' }}>
                                </div>
                            </td>
                        </tr>
                        @empty
