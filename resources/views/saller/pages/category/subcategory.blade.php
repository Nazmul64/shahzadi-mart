...
<div class="main-content">
    ...
    <div class="page-content" style="background: #f4f7fa;">
        <div class="page-header mb-4 px-3 pt-3">
            <h2 class="page-title font-w700" style="font-size: 24px; color: #333;">Sub Category List</h2>
        </div>
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f8f9fa;">
                            ...
                            <td class="text-muted">{{ $sub->category->category_name ?? 'N/A' }}</td>
                            <td class="font-w600" style="color: #333;">{{ $sub->sub_name }}</td>
                            <td class="text-end">
                                <div class="form-check form-switch d-inline-block">
                                    <input class="form-check-input custom-switch" type="checkbox" disabled {{ $sub->status == 'active' ? 'checked' : '' }}>
                                </div>
                            </td>
                        </tr>
                        @empty
