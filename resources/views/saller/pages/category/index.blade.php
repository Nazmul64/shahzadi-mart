...
<div class="page-content bg-light pb-5">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pt-2">
            <div>
                <h4 class="mb-1 fw-bold text-dark">Category List</h4>
                <p class="text-muted small mb-0">System categories available for your products</p>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse($categories as $key => $category)
                            <tr>
                                ...
                                <td class="fw-bold text-dark">{{ $category->category_name }}</td>
