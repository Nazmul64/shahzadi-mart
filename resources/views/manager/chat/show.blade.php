...
@section('content')
<div class="db-page" style="padding:16px 20px">

    {{-- ══ Page title ══ --}}
    <div class="d-flex align-items-center gap-3 mb-3">
        <a href="{{ route('manager.chat.index') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="chat-wrap">
        ...
        <div class="chat-sidebar">
            ...
            <div class="chat-session-list" id="sessionList">
                ...
                @endphp
                <a href="{{ route('manager.chat.show', $s->id) }}"
...
var CSRF         = '{{ csrf_token() }}';
var REPLY_URL    = '{{ route("manager.chat.reply",    $chatSession->id) }}';
var POLL_URL     = '{{ route("manager.chat.messages", $chatSession->id) }}';
var CLOSE_URL    = '{{ route("manager.chat.close",    $chatSession->id) }}';
var UNREAD_URL   = '{{ route("manager.chat.unread") }}';
var INDEX_URL    = '{{ route("manager.chat.index") }}';
var pollTimer;
