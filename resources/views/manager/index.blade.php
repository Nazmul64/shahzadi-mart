...
.db-card-title i { color: #10b981; font-size: 18px; } /* Emerald primary */
...
.db-card-link:hover { color: #059669; text-decoration: underline; }
...
.db-order-link:hover { color: #10b981; }
...
<div class="db-page">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <span style="background: #f1f5f9; color: #10b981; border-radius: 6px; padding: 4px 10px; font-size: 12px; font-weight: 700;">
    ...
    <div class="db-layout" style="grid-template-columns: 1fr;">
        ...
        <div class="db-card">
            <div class="db-card-header">
                <h5 class="db-card-title"><i class="bi bi-receipt-cutoff"></i> Recent Orders</h5>
                        ...
                        <table class="db-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                        <a href="{{ route('admin.order.show', $order->id) }}" style="background: #f1f5f9; color: #10b981; padding: 6px 12px; border-radius: 8px; font-size: 13px; font-weight: 600; text-decoration: none; display: inline-block; transition: all 0.2s;">
                                            Details
                                        </a>
                                    </td>
                                </tr>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Create gradient for chart - Emerald Green
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function(context) {
                            return context.parsed.y + ' Orders Completed';
                        }
                    }
                }
            },
