...
<div class="pur-wrap">
    ...
    <form action="{{ route('manager.purchases.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="pur-row">
                    ...
                    <div>
                        ...
                        <div class="supplier-row">
                            ...
                            <button type="button" class="pur-btn-plus" onclick="window.open('{{ route('manager.suppliers.create') }}', '_blank')">+</button>
                        </div>
        ...
        <div class="pur-footer">
            <a href="{{ route('manager.purchases.index') }}" class="pur-btn pur-btn-cancel">
                Cancel
            </a>
