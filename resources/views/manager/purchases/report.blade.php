...
<div class="pm-wrap">
    ...
    <form class="pm-filter" method="GET" action="{{ route('manager.purchases.report') }}">
        <div>
            <label>Product</label>
        ...
        <a href="{{ route('manager.purchases.report') }}" class="pm-btn pm-btn-ghost"><i class="bi bi-x-lg"></i> Clear</a>
    </form>
