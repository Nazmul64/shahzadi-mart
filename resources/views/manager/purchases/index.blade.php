...
<div class="pur-wrap">
    <div class="pur-top">
        ...
        <div style="display:flex;gap:8px;flex-wrap:wrap;">
            ...
            <a href="{{ route('manager.purchases.create') }}" class="pur-btn pur-btn-pink">
                + New Purchase
            </a>
        </div>
    </div>
    ...
    <form class="filter-card" method="GET" action="{{ route('manager.purchases.index') }}">
        <div>
        ...
        <div style="display:flex;gap:8px;align-items:flex-end;">
            ...
            <a href="{{ route('manager.purchases.index') }}" class="pur-btn" style="background:#6b7280;color:#fff;padding:9px 14px;">Reset</a>
        </div>
    </form>
