...
// =====================================================================
// ▼ KEY FIX: .name('admin.') — এটাই আগে ছিল না, এটাই সব সমস্যার কারণ ▼
// =====================================================================
Route::middleware(['admin'])->name('admin.')->group(function () {

    // Dashboard
    // আগে: ->name('admin.dashboard') লেখা ছিল — এখন group prefix আসায় শুধু ->name('dashboard') লিখলেই হবে
    ...
    // ── Permissions ───────────────────────────────────────────────────
    // bulk-create অবশ্যই resource() এর আগে
    ...
    // ── Products ──────────────────────────────────────────────────────
    // সব custom route অবশ্যই resource() এর আগে
